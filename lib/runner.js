var Monitor, argv, buildReady, builder, codeChange, filter, fs, hrLog, hrLogId, killApp, libMonitor, logger, moment, notifier, path, relativeName, restart, root, server, serverScript, spawn, srcMonitor, srvArgs, start, startTime, writeStderr, writeStdout;
