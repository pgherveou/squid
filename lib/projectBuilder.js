...
(function() {
  var CSBuilder, JSBuilder, JadeBuilder, StylusBuilder, async, buildFactory, config, exec, fileConfig, fs, logger, path, postBuild, util, walk, _,
  ...
  postBuild = function() {
    ...
    return postBuild.process = exec(config.post_build.cmd, function() {
