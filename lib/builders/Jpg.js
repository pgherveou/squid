...
var BuildError, Builder, JPEGBuilder, JpegTran, fs, mkdirp, optimizer, path, _ref,
...
module.exports = JPEGBuilder = (function(_super) {
  __extends(JPEGBuilder, _super);

  JPEGBuilder.prototype.fileExt = '.jpg';

  JPEGBuilder.prototype.outExt = '.jpg';

  function JPEGBuilder() {
    JPEGBuilder.__super__.constructor.apply(this, arguments);
    this.pngConfig = this.config.builders.jpeg;
  }

  JPEGBuilder.prototype.build = function(src, refresh, cb) {
    var out,
      _this = this;
