...
exports.Builder = Builder = (function() {
  ...
  function Builder(config) {
    ...
    this.buildDir = path.resolve(this.config.build);
  }

  Builder.prototype.deps = {};

  Builder.prototype.buildPath = function(source, ext) {
    var dir, fileDir, fileName, mapping, relative, _i, _len, _ref;
    if (ext == null) {
      ext = '.js';
    }
    ...
    dir = this.buildDir + fileDir.substring(this.srcDir.length);
